...
const OurWork = () => {
  return (
    ...
    <div className='sm:flex'>
      ...
      <h5 className='mt-3 xs:text-2xl text-1xl font-semibold primary-text'>About the Company</h5>
        <p className='mt-10 primary-text xs:text-xl md:w-3/4'>
        We at Bitance Labs envision a future where IT development projects extend as a form of human expression. We hereby put our passion for software development into purpose
      ...
      <div className='w-full text-center animate-float-2s'>
        <img src={GameControll} className="w-3/4 m-auto mt-10"/>
      </div>
    </div>
